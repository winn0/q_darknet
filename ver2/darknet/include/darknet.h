...
struct layer {
    ...
    int   * input_sizes;
    float **layers_output;
    unsigned char **layers_output_uint8;
    float **layers_delta;
    ...
    char *quantized_weights;
    float *quantization_per_channel_scale;
    float quantization_layer_scale;
    int *quantization_per_channel_zeropoint;
...
typedef struct network_state {
    ...
    float *truth;
    float *input;
    unsigned char *quantized_input;
    float quantized_input_scale;
    int quantized_input_zeropoint;
    float *delta;
    float *workspace;
    int train;
    int index;
